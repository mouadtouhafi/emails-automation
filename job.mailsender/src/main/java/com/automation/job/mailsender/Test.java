...
public class Test {
    public static void main(String[] args) throws Exception {
    	...
    	String pathToken = "C:\\Users\\touhafi\\eclipse-workspace\\HaggingFaceToken.txt"; // adjust path
        String token = Files.readString(Paths.get(pathToken)).trim();
    	String hfToken = token;
        

        /* This is our ai prompt */
        String prompt = "Write a short professional recruiter email for this job posting: We are hiring a Java developer with Spring Boot experience.";
        ...
        if (response.statusCode() == 200) {
            ...
            System.err.println("Error calling API. Status: " + response.statusCode());
        }
    }
}
